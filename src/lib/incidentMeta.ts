...
export const INCIDENT_META: Record<string, {
  ...
  'Accident':        { hex: '#fb923c', tailwindText: 'text-orange-400', tailwindBorder: 'border-orange-700', tailwindBg: 'bg-[#1c1208]', icon: 'Car' },
  'Rescue':          { hex: '#2dd4bf', tailwindText: 'text-teal-400',   tailwindBorder: 'border-teal-700',   tailwindBg: 'bg-[#091816]', icon: 'LifeBuoy' },
  'Medical':         { hex: '#4ade80', tailwindText: 'text-green-400',  tailwindBorder: 'border-green-700',  tailwindBg: 'bg-[#0a180d]', icon: 'HeartPulse' },
  'Alarm':           { hex: '#facc15', tailwindText: 'text-yellow-400', tailwindBorder: 'border-yellow-700', tailwindBg: 'bg-[#1a1a09]', icon: 'BellRing' },
  'Other':           { hex: '#94a3b8', tailwindText: 'text-slate-400',  tailwindBorder: 'border-slate-600',  tailwindBg: 'bg-[#0f1219]', icon: 'AlertTriangle' },
}
